...
* 
* */
public class R2_9_VectorTest {

	public static void main(String[] args) {
		//jdk1.4 버전일 때
		Vector v=new Vector(5, 3);
		//초기용량:5, 증가치:3
		//데이터가 꽊 찼을 때 저장 영역을 3만큼 늘린다
		...
		for(int i=1;i<5;i++) {
			v.add(i);//Integer객체로 autoboxing 되어 저장된다
		}
		System.out.println("벡터v의 현재 크기2: "+v.size());
		System.out.println("벡터v의 현재 용량2: "+v.capacity());
...
//			String str1=v2.get(i);
		...
		v3.add(new Float(4.0f));
		v3.add(Float.valueOf(9.41f));
		float sum=0;
		for(Float f:v3) {
